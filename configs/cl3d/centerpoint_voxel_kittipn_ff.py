...
data_root = '/remote-home/linmo2333/kitti_infos/'
input_modality = dict(
    use_lidar=True,
    use_camera=False,
    use_radar=False,
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'ff_patchnorm_infos_train.pkl',
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'ff_patchnorm_infos_val.pkl',
...
prototype_file = data_root + 'ff_patchnorm_infos_train.pkl'

custom_hooks = [
    dict(
        type='pseudolabel_hook', 
        gt_path=data_root + 'ff_patchnorm_infos_train.pkl', 
        test_cfg=None, 
        train_cfg=None, 
