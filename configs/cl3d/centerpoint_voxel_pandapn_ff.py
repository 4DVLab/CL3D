...
# point_cloud_range = [-51.2, -2.4, -5.0, 51.2, 100.0, 3.0]
# eval_range = 100
...
data_root = '/remote-home/share/pandaset/'
input_modality = dict(
    use_lidar=True,
    use_camera=False,
    use_radar=False,
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'ff_patchnorm_train_infos.pkl',
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'ff_patchnorm_val_infos.pkl',
...
custom_hooks = [
    dict(
        ...
        gt_path=data_root + 'ff_patchnorm_train_infos.pkl', 
        test_cfg=None, 
        train_cfg=None, 
