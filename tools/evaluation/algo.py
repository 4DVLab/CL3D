...
from nuscenes.eval.common.utils import center_distance, scale_iou, angle_diff, velocity_l2, attr_acc, cummean
...
def accumulate(gt_boxes: EvalBoxes,
    ...
    for ind in sortind:
        ...
        if is_match:
            ...
            match_data['orient_err'].append(angle_diff(gt_box_match.rotation[0], pred_box.rotation[0], period=period))
